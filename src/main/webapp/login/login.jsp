...
<head>
    ...
    <script>
        function changeImage() {
            document.getElementById("captchaImage").src="${path}/admin/Image?id="+Math.random();
                    ...
                    <div class="form-bottom" style="width: 450px">
                        <form role="form" action="${path}/admin/login" method="post" class="login-form" id="loginForm">
                            ...
                            <div class="form-group">
                                ...
                                <img id="captchaImage" style="height: 48px" onclick="changeImage()" class="captchaImage" src="${path}/admin/Image">
