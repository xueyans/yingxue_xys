...
<body>
                    ...
                    <div class="panel panel-info">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body">
                                ...
                                <button class="btn btn-info">
                                    <a href="javascript:$('#mainId').load('${path}/test/userChinaJson.jsp')">用户分布</a>
                                </button>
                            </div>
                        </div>
                    </div>
    ...
    <!--栅格系统-->
    <!--页脚-->
    <div class="panel panel-footer footer navbar-fixed-bottom "align="center">
        <span>@百知教育 xueys@zparkhr.com</span>
    </div>
