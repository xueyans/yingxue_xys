...
public class ALiYunTest {
    ...
    //说明 有备注无需修改的位置请勿改动。
    @Test
    public void testSendPhoneMsg() throws ClientException {
        ...
        request.setPhoneNumbers("13875703594,15277501272,15242513767");
        //必填:短信签名-可在短信控制台中找到
    ...
    public static void main(String[] args) {
        String phoneNumbers="17536016921"; //手机号 孟林 18634782434,
